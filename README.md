> **📌 스냅샷 저장소** — 이 저장소는 2026-08-27까지의 Mulmit 개발 기록을 보존하는
> 포트폴리오 스냅샷입니다. 실서비스([mulmit.com](https://mulmit.com))의 개발은
> 비공개 저장소에서 계속됩니다 — TradingView 차트 라이브러리의 계약 조건과,
> 커뮤니티·채점 기능의 어뷰징 방어 때문에 코드 공개를 여기서 멈춥니다.
> 여기 남은 코드·문서(데이터 소스 권리 판정, 실측 기록, 테스트 문화)는 그대로
> 읽을 수 있는 기록입니다. uptime 워크플로는 이 저장소에서 계속 돕니다.
