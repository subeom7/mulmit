...
ASSETS = (
    ...
    AssetSpec(
        ...
        "이더리움 무기한선물",
        "Ethereum perpetual",
        "Hyperliquid 자체 DEX에 상장된 이더리움 무기한선물입니다. 현물 거래소 가격이 아닙니다.",
        "An ether perpetual listed on Hyperliquid's own DEX; it is not a spot-exchange price.",
        "Ether / USD",
        "USD",
        "U.S. dollars",
        "USD",
    ...
    AssetSpec(
        ...
        "korea",
        "SK하이닉스 USD 환산 무기한선물",
        "SK hynix USD-converted perpetual",
        "SK하이닉스 보통주(KRX 000660)의 원화 기준가를 USD/USDC로 환산해 참조하는 합성 무기한선물입니다. SK하이닉스 원화 현물 주가가 아닙니다.",
        "A synthetic perpetual referencing SK hynix ordinary shares (KRX 000660) after KRW-to-USD/USDC conversion; it is not the KRW cash share price.",
        "SK hynix ordinary share (KRX 000660), KRW-to-USD converted reference",
        "USD",
        "USDC per converted share-reference unit",
        "USDC",
        "korea_equity_perpetual",
