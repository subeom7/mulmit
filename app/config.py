...
# 식약처 허가 이벤트("허가 그 후") — mfds blob에서 수집하고 FSC로 채점하는
# 합성 lane. 이벤트가 월 수십 건이라 예산은 작아도 넉넉하다.
BIO_EVENTS_MAX_AGE = _int("BIO_EVENTS_MAX_AGE", 60 * 60 * 6)
BIO_EVENTS_SCORE_PER_RUN = _int("BIO_EVENTS_SCORE_PER_RUN", 40)
