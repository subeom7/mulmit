...
const TEXT = {
  ko: {
    ...
    "krpage.sub": "한국장이 닫혀 있어도 주요 종목은 해외 시장에서 24시간 거래됩니다. 그 가격을 원화로 환산해 마지막 종가와 비교하고, 그 사이 쌓인 공시를 함께 봅니다.",
    "krpage.overnightNote": "장이 닫힌 시간의 참고가 · 실제 체결가 아님",
  ...
  en: {
    ...
    "krpage.sub": "Major Korean names keep trading offshore around the clock while Seoul is shut. We convert those prices to won, compare them with the last official close, and show the filings that piled up meanwhile.",
    "krpage.overnightNote": "Out-of-hours reference · not an executable price",
