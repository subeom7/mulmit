...
const TEXT = {
  ko: {
    ...
    "landing.cryptoLink": "크립토", "landing.cryptoDesc": "BTC·ETH 퍼프 참고가 · 공포·탐욕 · 펀딩비·OI · 김치프리미엄 · 실현 변동성",
    ...
    "kro.fxOfficial": "환율은 하루 한 번 고시값", "kro.vsClose": "{date} 종가 대비", "kro.mark": "마크", "kro.official": "공식 종가", "kro.fx": "환산 환율",
  ...
  en: {
    ...
    "kro.fxOfficial": "Converted at the daily official FX rate", "kro.vsClose": "vs {date} close", "kro.mark": "Mark", "kro.official": "Official close", "kro.fx": "FX applied",
...
function renderAll() {
  ...
  renderCryptoOverview(); renderCryptoSentiment(); renderCryptoDerivatives(); renderCryptoVolatility(); renderCryptoKimchi(); renderCryptoStructure(); renderCryptoGas(); renderCryptoBoard(); renderCryptoRegime(); renderCryptoNews(); renderBioTrials(); renderBioFda(); renderBioAdcomm(); renderBioMfds();
