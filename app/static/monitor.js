...
const state = {
  ...
  stress: null, sentiment: null, cryptoOverview: null, cryptoSentiment: null, cryptoVolatility: null, cryptoKimchi: null, cryptoStructure: null, cryptoGas: null, cryptoBoard: null, cryptoRegime: null, bioTrials: null, bioFda: null, bioAdcomm: null, bioMfds: null, bioFilter: "all", bioMfdsFilter: "notable", krOvernight: null, krPension: null, krHoldings: null, krEtf: null, usPtr: null, calendar: null,
...
function renderAttribution() {
  ...
  const laneReasons = [...new Set(["macro", "assets", "weekend", "sectors", "correlation", "stress", "sentiment", "cryptoOverview", "cryptoSentiment", "cryptoVolatility", "cryptoKimchi", "cryptoStructure", "cryptoGas", "cryptoBoard", "cryptoRegime", "bioTrials", "bioFda", "bioAdcomm", "bioMfds"]
...
async function loadCore() {
  ...
  state.cryptoKimchi = cryptoKimchi; state.cryptoStructure = cryptoStructure; state.cryptoGas = cryptoGas; state.cryptoBoard = cryptoBoard; state.cryptoRegime = cryptoRegime; state.bioTrials = bioTrials; state.bioFda = bioFda; state.bioAdcomm = bioAdcomm; state.bioMfds = bioMfds;
...
function renderAll() {
  ...
  renderCryptoOverview(); renderCryptoSentiment(); renderCryptoDerivatives(); renderCryptoVolatility(); renderCryptoKimchi(); renderCryptoStructure(); renderCryptoGas(); renderCryptoBoard(); renderCryptoRegime(); renderBioTrials(); renderBioFda(); renderBioAdcomm(); renderBioMfds();
