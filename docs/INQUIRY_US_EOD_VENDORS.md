...
상태: **Tiingo 발송 완료 (2026-08-18)** — `sales@tiingo.com`, Gmail id `1a01040c2aa96520`.
EODHD(2순위)는 미발송 — Tiingo 회신이 예산 밖일 때 같은 본문으로 보낸다.
견적 요청이지 구매가 아니다 — 등록부 원칙상 서면 확인·예산 판단 전에는 결제하지 않는다.
